 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=tr_TR',
    UPLOAD_PHOTO_TEXT: "Fotoğraf yükle",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Fotoğraf çek",
    UPLOAD_FACEBOOK_TEXT: "Facebook'tan seç",
    UPLOAD_INSTA_TEXT: "Instagram'dan seç",
    COMMENT_TEXT: "Yorum",
    NICKNAME_TEXT: "Takma ad",
    RIGHTS_MANG_TEXT: "koşullar ve hükümler maddelerini kabul ediyorum",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Geri",
