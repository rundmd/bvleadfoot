...
define({
    ...
    UPLOAD_FACEBOOK_TEXT: "Επιλογή από το Facebook",
    UPLOAD_INSTA_TEXT: "Επιλογή από το Instagram",
    COMMENT_TEXT: "Σχόλιο",
    NICKNAME_TEXT: "Ψευδώνυμο",
    RIGHTS_MANG_TEXT: "Συμφωνώ με Όροι και Προϋποθέσεις",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Πίσω",
