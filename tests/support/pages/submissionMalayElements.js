 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=ms_MY',
    UPLOAD_PHOTO_TEXT: "Muat naik foto",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Ambil foto",
    UPLOAD_FACEBOOK_TEXT: "Pilih daripada Facebook",
    UPLOAD_INSTA_TEXT: "Pilih daripada Instagram",
    COMMENT_TEXT: "Komen",
    NICKNAME_TEXT: "Nama samaran",
    RIGHTS_MANG_TEXT: "Saya bersetuju dengan terma dan syarat",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Kembali",
