 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=sl-si',
    UPLOAD_PHOTO_TEXT: "Naložite fotografijo",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Posnemite fotografijo",
    UPLOAD_FACEBOOK_TEXT: "Izberite s Facebooka",
    UPLOAD_INSTA_TEXT: "Izberite z Instagrama",
    COMMENT_TEXT: "Komentar",
    NICKNAME_TEXT: "Vzdevek",
    RIGHTS_MANG_TEXT: "Strinjam se s Pogoji uporabe",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Nazaj",
