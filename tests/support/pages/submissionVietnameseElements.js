 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=vi-vn',
    UPLOAD_PHOTO_TEXT: "Tải hình lên",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Chụp hình",
    UPLOAD_FACEBOOK_TEXT: "Chọn từ Facebook",
    UPLOAD_INSTA_TEXT: "Chọn từ Instagram",
    COMMENT_TEXT: "Ý kiến",
    NICKNAME_TEXT: "Biệt danh",
    RIGHTS_MANG_TEXT: "Tôi đồng ý với các điều khoản và điều kiện",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Trở lại",
