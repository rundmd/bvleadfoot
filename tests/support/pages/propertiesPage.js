define({
  ...
  COOKIE: [{name: "intro-shown", value: "true", path: "/", domain: "sam.feedmagnet.com"}],
  FILTER_TIMEOUT: 7000,
  ...
  PHOTO_UPLOAD_LOCATION: '/files/BV_background_4_1440x900.png',
  VIDEO_UPLOAD_LOCATION: '/files/testvid.mp4',
