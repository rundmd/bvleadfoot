 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=ja-jp',
    UPLOAD_PHOTO_TEXT: "画像をアップロードする",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "写真を撮る",
    UPLOAD_FACEBOOK_TEXT: "Facebook から選ぶ",
    UPLOAD_INSTA_TEXT: "Instagram から選ぶ",
    COMMENT_TEXT: "コメント",
    NICKNAME_TEXT: "ニックネーム",
    RIGHTS_MANG_TEXT: "契約条件 に同意します",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "戻る",
