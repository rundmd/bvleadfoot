 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=fr-fr',
    UPLOAD_PHOTO_TEXT: "Charger une photo",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Prendre une photo",
    UPLOAD_FACEBOOK_TEXT: "Choisir à partir de Facebook",
    UPLOAD_INSTA_TEXT: "Choisir à partir d'Instagram",
    COMMENT_TEXT: "Commentaire",
    NICKNAME_TEXT: "Nom d'utilisateur",
    RIGHTS_MANG_TEXT: "J'accepte les conditions générales",
    POST_BTN_TEXT: "Post",
