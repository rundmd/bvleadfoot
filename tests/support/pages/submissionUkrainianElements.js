 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=uk-ua',
    UPLOAD_PHOTO_TEXT: "Завантажити фото",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Зробити фото",
    UPLOAD_FACEBOOK_TEXT: "Вибрати з Facebook",
    UPLOAD_INSTA_TEXT: "Вибрати з Instagram",
    COMMENT_TEXT: "Прокоментувати",
    NICKNAME_TEXT: "Нік",
    RIGHTS_MANG_TEXT: "Я приймаю умови умови",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Назад",
