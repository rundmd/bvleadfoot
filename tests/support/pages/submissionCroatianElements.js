 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=hr_HR',
    UPLOAD_PHOTO_TEXT: "Prenesite fotografiju",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Fotografirajte",
    UPLOAD_FACEBOOK_TEXT: "Odaberite s Facebooka",
    UPLOAD_INSTA_TEXT: "Odaberite s Instagrama",
    COMMENT_TEXT: "Komentar",
    NICKNAME_TEXT: "Nadimak",
    RIGHTS_MANG_TEXT: "Slažem se s uvjeti i odredbe",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Nazad",
