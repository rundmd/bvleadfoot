 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=ro_RO',
    UPLOAD_PHOTO_TEXT: "Încarcă o poză",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Fă o poză",
    UPLOAD_FACEBOOK_TEXT: "Alege de pe Facebook",
    UPLOAD_INSTA_TEXT: "Alege de pe Instagram",
    COMMENT_TEXT: "Comentariu",
    NICKNAME_TEXT: "Poreclă",
    RIGHTS_MANG_TEXT: "Sunt de acord cu termeni și condiții",
    POST_BTN_TEXT: "Post",
