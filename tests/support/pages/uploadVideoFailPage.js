    ...
    uploadVideoFailPage.prototype={
        ...
        uploadPlusComment:function()
        {
            ...
            return session
                ...
                .then(function(){
                    return actions.enterText(session,elements.UPLOAD_VIDEO_COMMENT_LOCATOR, "the greatest of all time", 'xpath');
                })
        ...
        uploadPlusNickname: function () {
            ...
            return session
                ...
                .setFindTimeout(10000)
                .then(function(){
                    return actions.clickAButton(session, elements.UPLOAD_VIDEO_BTN_LOCATOR, 'xpath');
                })
                .then(function(){
                    return actions.uploadFile(session,elements.UPLOAD_VIDEO_BTN_LOCATOR2, '/Users/brendon.kelley/projects/bvleadfoot/tests/support/pages/testvid.mp4', 'xpath');
                })
                .then(function(){
                    return actions.enterText(session,elements.UPLOAD_VIDEO_NICKNAME_LOCATOR, "bk", 'xpath');
                })
                .findByXpath(elements.UPLOAD_SUBMIT_BTN_LOCATOR)
                .isEnabled()
        },
