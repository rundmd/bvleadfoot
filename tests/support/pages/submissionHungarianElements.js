 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=hu_HU',
    UPLOAD_PHOTO_TEXT: "Fénykép feltöltése",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Fénykép készítése",
    UPLOAD_FACEBOOK_TEXT: "Választás a Facebookról",
    UPLOAD_INSTA_TEXT: "Választás a Instagramról",
    COMMENT_TEXT: "Megjegyzés",
    NICKNAME_TEXT: "Becenév",
    RIGHTS_MANG_TEXT: "Beleegyezem a következőbe: Felhasználási feltételek",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Vissza",
