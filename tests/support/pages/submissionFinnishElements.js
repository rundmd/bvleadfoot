 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=fi_FI',
    UPLOAD_PHOTO_TEXT: "Vie kuva",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Ota kuva",
    UPLOAD_FACEBOOK_TEXT: "Valitse Facebookista",
    UPLOAD_INSTA_TEXT: "Valitse Instagramista",
    COMMENT_TEXT: "Kommentoi",
    NICKNAME_TEXT: "Lempinimi",
    RIGHTS_MANG_TEXT: "Hyväksyn käyttöehdot",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Takaisin",
