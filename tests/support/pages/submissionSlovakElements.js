 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=sk-sk',
    UPLOAD_PHOTO_TEXT: "Odovzdať fotografiu",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Fotografovať",
    UPLOAD_FACEBOOK_TEXT: "Vybrať z Facebooku",
    UPLOAD_INSTA_TEXT: "Vybrať z Instagramu",
    COMMENT_TEXT: "Komentár",
    NICKNAME_TEXT: "Prezývka",
    RIGHTS_MANG_TEXT: "Súhlasím so zmluvnými podmienkami zmluvné podmienky",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Späť",
