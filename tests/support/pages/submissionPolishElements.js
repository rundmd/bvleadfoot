 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=pl-pl',
    UPLOAD_PHOTO_TEXT: "Załaduj zdjęcie",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Zrób zdjęcie",
    UPLOAD_FACEBOOK_TEXT: "Wybierz z Facebooka",
    UPLOAD_INSTA_TEXT: "Wybierz z Instagramu",
    COMMENT_TEXT: "Komentarz",
    NICKNAME_TEXT: "Pseudonim",
    RIGHTS_MANG_TEXT: "Akceptuję warunki",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Powrót",
