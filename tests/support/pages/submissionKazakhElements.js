...
define({
    ...
    UPLOAD_FACEBOOK_TEXT: "Facebook желісінен таңдау",
    UPLOAD_INSTA_TEXT: "Instagram желісінен таңдау",
    COMMENT_TEXT: "Түсініктеме",
    NICKNAME_TEXT: "Бүркеншік ат",
    RIGHTS_MANG_TEXT: "шарттар мен талаптар бөлімімен келісемін",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Артқа",
