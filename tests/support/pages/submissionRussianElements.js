 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=ru_RU',
    UPLOAD_PHOTO_TEXT: "Загрузить фотографию",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "Сделать фотографию",
    UPLOAD_FACEBOOK_TEXT: "Выбрать в Facebook",
    UPLOAD_INSTA_TEXT: "Выбрать в Instagram",
    COMMENT_TEXT: "Комментарий",
    NICKNAME_TEXT: "Ник",
    RIGHTS_MANG_TEXT: "Я согласен(-на) с условия и положения",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "Назад",
