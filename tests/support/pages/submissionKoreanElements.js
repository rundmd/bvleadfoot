 ...
 */
define({
    SUBMISSION_URL:'https://submit-stg.curations.bazaarvoice.com/?client=curations-one&productId=product1&group=pie-test&locale=ko-kr',
    UPLOAD_PHOTO_TEXT: "사진 업로드",
    UPLOAD_VIDEO_TEXT: "laden Sie ein Video",
    TAKE_PHOTO_TEXT:   "사진 촬영",
    UPLOAD_FACEBOOK_TEXT: "Facebook에서 선택",
    UPLOAD_INSTA_TEXT: "Instagram에서 선택",
    COMMENT_TEXT: "설명",
    NICKNAME_TEXT: "별명",
    RIGHTS_MANG_TEXT: "본인은 이용 약관에 동의합니다.",
    POST_BTN_TEXT: "Post",
    BACK_BTN_TEXT: "뒤로",
